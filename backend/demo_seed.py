...
INITIAL_CANDIDATES = [
    {
        ...
        'runningMate': {'name': 'Blessing Tariere George', 'department': 'Medical Biochemistry', 'level': '400L'},
    ...
    },
    {
        ...
        'runningMate': {'name': 'Kelechi Stephanie Nwosu', 'department': 'Pharmacology', 'level': '400L'},
        'approvedByEleco': True,
    },
    {
        'id': 'cand-vp-1',
